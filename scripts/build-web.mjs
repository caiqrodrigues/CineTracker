...
if (!built.includes('patch-v075-hotfix2-version.js')) throw new Error('HOTFIX 2 version marker missing from built HTML.');
...
console.log('CineTracker 0.0.97 HOTFIX 2: auth recovery active; Android startup recovery build; FIX 7 removed from runtime');
