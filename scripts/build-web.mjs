...
const patch043 = resolve(web, 'patch-v043.js');
const patch042 = resolve(web, 'patch-v042.js');
const patch044 = resolve(web, 'patch-v044.js');
...
for (const dist of [rootDist, webDist]) {
  ...
  for (const f of [patch024,patch025,patch025Profile,patch027,patch028,patch029,patch030,patch034,patch035,patch036,patch037,patch038,patch040,patch041,patch043,patch042,patch044]) await cp(f, resolve(dist, f.split('/').pop()));
}
console.log('CineTracker Web 0.4.6 publicado em dist/ e apps/web/dist/');
