...
for (const dist of [rootDist, webDist]) {
  ...
  for (const f of [patch024,patch025,patch025Profile,patch027,patch028,patch029,patch030,patch034,patch035,patch036,patch037,patch038,patch040]) await cp(f, resolve(dist, f.split('/').pop()));
}
console.log('CineTracker Web 0.4.2 publicado em dist/ e apps/web/dist/');
