...
assert.ok(!pkg.includes('apply-web-v0993.mjs'));
...
assert.ok(!html.includes('patch-v097-v0993-nav-pre.js'));
assert.ok(!html.includes('patch-v098-v0993-web.js'));
...
assert.ok(!authority.includes('new MutationObserver('));
