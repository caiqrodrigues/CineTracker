...
for(const marker of[
  ...
  "android-v0.99.7.3-r150-realtime",
  'v09973-r150-realtime-sync'
...
console.log('ANDROID_09973_TEST_OK calendar=today watchlist=real realtime=websocket foreground=onResume layout=apk-existing');
