...
const marker = `<script>\nwindow.__ctAndroidBundle = 'v0.99.2-fix2-unfreeze-991-992-authoritative';\nwindow.__ctAndroidBuild = '0.99.2';\n</script>`;
...
if (!html.includes("window.__ctAndroidBundle = 'v0.99.2-fix2-unfreeze-991-992-authoritative'")) throw new Error('Android 0.99.2 FIX2 bundle marker missing.');
...
console.log(`Android 0.99.2 FIX2 bundle prepared with ${scripts.length} inlined scripts; 99.1 + 99.2 + unfreeze guard active.`);