...
for(const must of ['data-done="1"','data-fm="106"','data-fs="112"','data-fa="120"','data-wm="202"','data-block-fresh="true"','data-block-wl10="true"','data-block-wl40="false"','data-block-swap="true"','data-collapsed="true"','P1 Ayrton Teste Equipe A 1:20.000'])if(!out.includes(must))throw new Error('V113 contract missing '+must+'\n'+out.slice(-6000));
