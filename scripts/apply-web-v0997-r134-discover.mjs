...
const source=resolve(root,'dist/patch-v131-v0997-rich-movie-discover.js');
...
if(js.includes('shiftDays(540)')||js.includes("release_date.lte':future"))throw new Error('r134 Discover must inherit transformed unlimited future window');
...
console.log('WEB_R134_DISCOVER fresh physical runtime emitted from transformed r131');
