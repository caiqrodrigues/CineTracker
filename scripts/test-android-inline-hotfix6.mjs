...
for(const marker of ['__ct98NavPre','__ct0991Loaded','__ct0992Loaded','ct0992Navigate','cinetracker_profile_home_dashboard_v0992','Assistir a seguir','Juntando poeira','Em dia','Não Iniciadas / Watchlist','Concluídas','Escolha para Hoje','daily_movie_recommendations_v0992','CineTracker • v0.99.2'])if(!html.includes(marker))throw new Error(`Android 0.99.2 marker missing: ${marker}`);
...
console.log(`Android 0.99.2 inline smoke OK: ${scripts.length} scripts; reactive Series/Movies Home present.`);
