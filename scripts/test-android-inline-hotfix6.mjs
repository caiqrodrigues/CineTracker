...
if(navIndex<0||selectiveIndex<0||pickerIndex<0||semanticsIndex<0||!(navIndex<selectiveIndex&&selectiveIndex<pickerIndex&&pickerIndex<semanticsIndex))throw new Error('Android inline smoke: HOTFIX14 patch order invalid');
const markers=['__ctHotfix14RealDevice','ct14RestoreNativeFiles','__ctHotfix12PickerGuard','__ctHotfix10Selective','__ctHotfix10Actions','__ctHotfix10NativeBridge','__ctHotfix11ImportSync','__ctHotfix11SettingsBridge','__ctHotfix13BingersSemantics'];
...
console.log(`Android HOTFIX14 inline smoke OK: ${scripts.length} scripts; persistent native picker bridge; verified navigation; v97 absent.`);