...
const pos=order.map(x=>html.indexOf(`data-ct-inline="${x}"`));if(!pos.every((x,i)=>x>=0&&(i===0||x>pos[i-1])))throw new Error('Android 0.99.2 FIX2 patch order invalid');
...
console.log(`Android 0.99.2 FIX2 inline smoke OK: ${scripts.length} scripts; unfreeze + authoritative navigation/write/profile compatibility present.`);
