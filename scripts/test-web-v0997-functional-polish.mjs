...
must(src.includes("if(tt&&row.title)tt.textContent=row.title")&&src.includes("if(!safe&&pt&&pt.tagName!=='IMG')pt.style.backgroundImage=''"),'0.99.7 v121: proteção visual contra título/capa persistidos incorretos ausente.');
