...
for(const x of ['__ct0997DeepLink134Loaded','/movie/','/series/','/person/','collapseSeasons(shell)','cards.forEach((c,i)=>c.hidden=i>=10)','Ver todo elenco','Ver todos os filmes','Ver todas as séries',"data-ct132-add-favorite=\"movie\"",'ct132-profile-preview','nth-child(n+11)','data-ct120-route=\\"settings\\"'])if(!routes.includes(x))throw new Error('r134 routes missing '+x);
