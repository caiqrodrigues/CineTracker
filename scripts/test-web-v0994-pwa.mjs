...
assert.match(gradle, /versionName '0\.99\.6'/, 'Android must be synchronized to 0.99.6 in this release');
assert.match(gradle, /versionCode 9960/, 'Android 0.99.6 versionCode must be 9960');
...
console.log('WEB_0994_PWA_OK navigation=nonblocking home-timeout=guarded stale-cache=fallback android=0.99.6-synchronized');
