...
new Function(s);
const must=["window.__ctR209='v105-video-corrections'",'data-ct105-rewatch-movie','data-ct105-rewatch-episode','data-ct105-history-rewatch','ct104MovieRewatch','ct104EpisodeRewatch','ct104PaintF1=async function','cinetracker-f1-v1','action:\'overview\'','current105','ct104Blocked=function','--ct104-card-w'];
