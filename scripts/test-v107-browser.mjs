...
const post=`<script>{let n=0;const t=setInterval(()=>{n++;const b=document.querySelector('[data-ct107-rewatch="episode"]');if(b){clearInterval(t);b.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true}))}else if(n>30)clearInterval(t)},100)}</script>`;
