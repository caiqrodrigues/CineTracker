...
['FIX sessão persistida e restart',fix.includes('persistSessionFix')&&fix.includes("localStorage.setItem('cinetracker_session'")&&fix.includes('restartFromPersistedSession')&&fix.includes("sessionStorage.setItem('ct097_fix2_post_login','1')")&&fix.includes('location.reload()')],
