...
const webFiles=['patch-v024.js','patch-v029.js','patch-v054.js','patch-v058-v088.js','patch-v059-v089.js','patch-v060-v090.js','patch-v061-v090-android-export.js','patch-v061-v091.js','patch-v062-v091-preserve.js','service-worker.js'];
...
const p29=src['patch-v029.js'],p54=src['patch-v054.js'],p58=src['patch-v058-v088.js'],p59=src['patch-v059-v089.js'],p60=src['patch-v060-v090.js'],p91=src['patch-v061-v091.js'],p62=src['patch-v062-v091-preserve.js'];
const checks=[
...
['Gráfico consumo anterior preservado',p62.includes('Consumo dos últimos 7 dias')&&p62.includes('preserveProfile')],
...
['Config preferências anteriores preservadas',p62.includes('Visualização padrão')&&p62.includes('Sair da conta')&&p62.includes('ct54-layout')],
['Ator e filmografia preservados',p62.includes('openActor91')&&p62.includes('/combined_credits')&&p62.includes('data-credit91')&&p62.includes('ct91OpenMedia')],
...
['Rodapé só v91 em runtime',p91.includes("CineTracker • v91")&&p91.includes(".ct89-version,.ct90-version,.ct54-version,.ct91-version")&&p62.includes('enforceFooter')],
...
['Android módulo v91',android.includes('ct79-v091.js')&&a91.includes("window.__ctAndroidBuild='0.0.91'")&&a91.includes('/patch-v062-v091-preserve.js')],
