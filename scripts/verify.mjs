...
['Descobrir TMDB preservado',p92.includes('/trending/all/week')&&p92.includes('/movie/upcoming')],
...
['Android FIX7 version',gradle.includes('versionCode 977')&&gradle.includes("versionName '0.0.97 FIX 7'")&&gradle.includes('copyV097Fix7Asset')],
