...
const p91=src['patch-v061-v091.js'],p92=src['patch-v063-v092.js'],v98=src['patch-v089-v098.js'],pre=src['patch-v088-v098-nav-pre.js'],v99=src['patch-v091-v099-profile-lru.js'],v991=src['patch-v092-v0991.js'],v992=src['patch-v093-v0992.js'],v992c=src['patch-v094-v0992-compat.js'],fix=src['patch-v095-v0992-fix.js'],sem=src['patch-v083-hotfix13-bingers-semantics.js'],h16=src['patch-v087-hotfix16-import-resilience.js'],sw=src['service-worker.js'];
...
['fix final carregado por último',ordered&&selective.includes("const fix992='patch-v095-v0992-fix.js'")],
...
['Android FIX bundle 0.99.2',prepare.includes('v0.99.2-fix-991-992-authoritative')&&prepare.includes('patch-v095-v0992-fix.js')&&prepare.includes('__ct0992FixLoaded')],
