...
['Importação mapeia campos obrigatórios',p97.includes('tmdb_id')&&p97.includes('tvdb_id')&&p97.includes('season_number')&&p97.includes('episode_number')&&p97.includes('first_watched_at')&&p97.includes('last_watched_at')&&p97.includes('plays')],
