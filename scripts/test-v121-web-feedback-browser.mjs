...
for(const must of ['data-done="1"','data-pending="Buscando recomendação…"','data-refreshes="1"','data-series="1"','data-actions="2"','data-events="1"','data-watched="1"','data-modal="true"','data-rows="1"','data-jwt-leak="false"'])if(!out.includes(must))throw new Error('V121 contract missing '+must+'\n'+out.slice(-12000));
