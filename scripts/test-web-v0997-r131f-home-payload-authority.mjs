...
if(!html.includes('patch-v131e-v0997-enable-runtime.js"></script><script src="/patch-v131f-v0997-home-payload-authority.js'))throw new Error('r131f must load immediately after r131e');
