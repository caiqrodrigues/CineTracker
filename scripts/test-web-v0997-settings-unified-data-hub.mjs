...
const a=html.indexOf('<script src="/patch-v126-v0997-video3124-recovery.js"></script>');
const b=html.indexOf('<script src="/patch-v127-v0997-settings-unified-data-hub.js"></script>');
