...
if(hotfix.includes(replayLoop))hotfix=hotfix.replace(replayLoop,safeReplayLoop);else if(!hotfix.includes(safeReplayLoop))throw new Error('Android safe replay loop missing');
