...
let patch=await readFile(resolve(root,'apps/web/runtime-r211-v107-behavior.js'),'utf8');
...
if(patch.includes('cinetracker_mark_episode_v0994'))throw new Error('Android 1.0.7 must not call nonexistent episode RPC');
...
console.log('ANDROID_1_0_7_READY runtime=r249 base=r246/r243');
