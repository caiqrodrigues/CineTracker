...
let [patch,rewatch]=await Promise.all([
 readFile(resolve(root,'apps/web/runtime-r211-v107-behavior.js'),'utf8'),
...
for(const m of ["window.__ctR212='v107-direct-rewatch-authority'",'ct212Bound','cinetracker_mark_watch_v0994'])if(!rewatch.includes(m))throw new Error('Android 1.0.7 replay authority missing '+m);
...
console.log('ANDROID_1_0_7_READY runtime=r249/r212 base=r246/r243');
