...
const unfreeze992='patch-v096-v0992-unfreeze.js';
const names=[
  pre98,
...
for(const target of targets){
  ...
  for(const name of [pre98,profileName,ui98,compat98,profile99,release991,release992,compat992,fix992,unfreeze992]){
...
console.log('CineTracker 0.99.2 FIX2: v95/v98 + 0.99.1 + 0.99.2 preserved; unfreeze guard emitted last.');
