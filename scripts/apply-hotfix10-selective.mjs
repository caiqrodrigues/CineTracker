...
for(const target of targets){
  ...
  if(html.includes('patch-v068-'+'v097.js'))throw new Error(`v0.99.2: v97 overlay must remain absent: ${indexPath}`);
  if(!html.includes('patch-v067-v095.js'))throw new Error(`v0.99.2: stable v95 core missing: ${indexPath}`);
  ...
  for(const name of [pre98,profileName,ui98,compat98,profile99,release991,release992]){
  ...
  const order=['patch-v088-v098-nav-pre.js','patch-v085-hotfix15-import-transport.js','patch-v075-hotfix10-selective.js','patch-v082-hotfix12-picker-guard.js','patch-v083-hotfix13-bingers-semantics.js','patch-v087-hotfix16-import-resilience.js',profileName,ui98,compat98,profile99,release991,release992];
...
console.log('CineTracker 0.99.2: stable v95/v98 core retained; v0.99.2 Series/Movies Home layer emitted last.');
