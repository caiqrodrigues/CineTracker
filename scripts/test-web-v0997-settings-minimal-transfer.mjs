...
new Function(meta);new Function(stable);
...
console.log('WEB_0997_SETTINGS_V128_V129_NAV_V130_OK metadata=real sidebar=locked footer=stable scope=settings+sidebar');
