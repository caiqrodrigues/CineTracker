...
assert.ok(a>=0&&b>a,'settings v128 must load once after v127');
assert.equal((html.match(/patch-v128-v0997-settings-minimal-transfer\.js/g)||[]).length,1,'settings v128 duplicated');
console.log('WEB_0997_SETTINGS_V128_OK scope=settings visible=import+export formats=on-demand bingers=hidden-until-csv');
