...
const [js,build]=await Promise.all([
...
console.log('R185B_WEB_PREFETCH_OK shell-before-loader=true profile=quick-only sports=warm discover=warm historical=true');
