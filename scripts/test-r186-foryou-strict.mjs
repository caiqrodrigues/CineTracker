...
console.log('R186_FORYOU_STRICT_OK score>=7.5 year>=1991 history=blocked watchlist=conditional drama=pure-only documentary=blocked unique=7 realtime=true');
