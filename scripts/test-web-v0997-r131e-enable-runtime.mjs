...
if(!normalizedHtml.includes('patch-v131d-v0997-real-data-path.js"></script><script src="/patch-v131e-v0997-enable-runtime.js'))throw new Error('r131e must load immediately after r131d');
