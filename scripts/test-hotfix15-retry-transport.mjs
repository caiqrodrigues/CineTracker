...
async function makeRuntime(fakeFetch){
...
console.log(`HOTFIX15_RETRY_TRANSPORT_OK transient503=${calls503}; network=${callsNetwork}; begin_single_shot=${beginCalls}; timeout=enabled`);
