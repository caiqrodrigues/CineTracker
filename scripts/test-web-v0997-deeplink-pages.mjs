...
for(const dir of ['dist','apps/web/dist']){
  ...
  if(!runtime.includes('v132-url-router-fullscreen-details-profile-10-more')||!runtime.includes('v132-single-runtime-nav-integrity'))throw new Error(`Web r132: composed runtime incomplete in ${dir}.`);
}
