...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "0.0.86";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            @Override public void onPageFinished(WebView view, String url) {
                ...
                webView.postDelayed(() -> webView.setVisibility(View.VISIBLE), 250);
            }
        });
        ...
        if (savedInstanceState == null) {
            ...
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=86");
        } else {
    ...
    private void navigate(String target) {
        String js = "(function(){try{" +
                "if(window.ct86Navigate&&window.ct86Navigate('" + target + "'))return true;" +
                "if(window.ct85Navigate&&window.ct85Navigate('" + target + "'))return true;" +
    ...
    private void applyStableModules() {
        String[] assets = {"ct47.js", "ct66.js", "ct67-profile-history.js", "ct68-final.js", "ct70-home-084.js", "ct71-cast-profile-084.js", "ct72-v085.js", "ct74-v086-final.js"};
