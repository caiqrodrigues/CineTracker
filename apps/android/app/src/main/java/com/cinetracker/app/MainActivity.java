...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "0.0.59";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=59");
        } else {
    ...
    private void applyAndroidBase() {
        ...
        String js = "(function(){" +
                ...
                "window.__ctAndroidBuild='0.0.59';" +
                "})();";
        webView.evaluateJavascript(js, null);
    }

    private void applyStableModules() {
        String[] assets = {"ct41.js", "ct47.js", "ct48.js", "ct49.js"};
