...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "0.0.79";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            @Override public void onPageFinished(WebView view, String url) {
                ...
                webView.postDelayed(() -> webView.setVisibility(View.VISIBLE), 350);
            }
        });

        bindNativeNavigation();
        requestNotificationPermission();
        webView.postDelayed(() -> webView.setVisibility(View.VISIBLE), 1400);
        if (savedInstanceState == null) {
            String separator = BuildConfig.WEB_URL.contains("?") ? "&" : "?";
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=79");
        } else {
    ...
    private void navigate(String target) {
        String js = "(function(){try{" +
                "if(window.ct64Navigate&&window.ct64Navigate('" + target + "'))return true;" +
    ...
    private void applyStableModules() {
        String[] assets = {"ct63.js", "ct47.js", "ct48.js", "ct50.js", "ct61.js", "ct64.js"};
