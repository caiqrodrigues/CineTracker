...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=87");
        } else {
    ...
    private void navigate(String target) {
        String js = "(function(){try{" +
                "if(window.ct87Navigate&&window.ct87Navigate('" + target + "'))return true;" +
    ...
    private void applyAndroidBase() {
        ...
        String js = "(function(){" +
                ...
                "window.__ctAndroidBuild='0.0.87';" +
                "})();";
        webView.evaluateJavascript(js, null);
    }

    private void applyStableModules() {
        String[] assets = {"ct47.js", "ct66.js", "ct67-profile-history.js", "ct68-final.js", "ct70-home-084.js", "ct71-cast-profile-084.js", "ct72-v085.js", "ct74-v086-final.js", "ct75-v087.js"};
