...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null){String separator=BuildConfig.WEB_URL.contains("?")?"&":"?";webView.loadUrl(BuildConfig.WEB_URL+separator+"android=1&ui=phone&apk="+BuildConfig.VERSION_CODE+"&fix=5&authrev=5");} else {webView.restoreState(savedInstanceState);webView.postDelayed(()->{applyAndroidBase();applyStableModules();},120);}
    }
