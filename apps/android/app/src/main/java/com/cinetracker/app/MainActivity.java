...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "0.0.52";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=52");
        } else {
    ...
    private void navigate(String target) {
        String js = "(function(){try{" +
                "if(window.ct50Navigate&&window.ct50Navigate('" + target + "')){setTimeout(function(){window.ct52Refresh&&window.ct52Refresh();},80);return true;}" +
                "if(window.ct48Navigate&&window.ct48Navigate('" + target + "')){setTimeout(function(){window.ct52Refresh&&window.ct52Refresh();},80);return true;}" +
                "if(window.ct47Navigate&&window.ct47Navigate('" + target + "')){setTimeout(function(){window.ct52Refresh&&window.ct52Refresh();},80);return true;}" +
                "view='" + target + "';render();window.scrollTo(0,0);setTimeout(function(){window.ct52Refresh&&window.ct52Refresh();},80);return true;" +
    ...
    @Override public void onBackPressed() {
        ...
        webView.evaluateJavascript("(function(){try{if(window.ct52Back&&window.ct52Back())return true;return !!(window.ct50Back&&window.ct50Back());}catch(e){return false;}})();", value -> {
