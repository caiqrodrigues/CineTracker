...
public class MainActivity extends Activity {
    ...
    private void navigateTo(String... terms) {
        ...
        String js = "(function(){" +
                "var words=" + words + ";" +
                "var els=[].slice.call(document.querySelectorAll('button[data-view],.nav button,.sidebar button,a'));" +
                "for(var i=0;i<els.length;i++){var t=((els[i].textContent||'').trim()).toLowerCase();" +
                "for(var j=0;j<words.length;j++){if(t.indexOf(words[j])>=0){els[i].click();window.scrollTo(0,0);return true;}}}" +
                "return false;})();";
    ...
    private String androidPhoneLayoutScript() {
        return "(function(){" +
                ...
                "if(!document.getElementById('ct-android-phone-style')){" +
                "var s=document.createElement('style');s.id='ct-android-phone-style';s.textContent=`" +
                ...
                "body{margin:0!important;padding:0!important;}*{max-width:100%;}" +
                ".app{display:block!important;grid-template-columns:1fr!important;width:100%!important;min-width:0!important;min-height:100%!important;}" +
                ".sidebar,.mobile-nav,.ct-bottom-nav,.ct-more-sheet{display:none!important;}" +
                ...
                ".h1{font-size:22px!important;line-height:1.18!important;margin:3px 0 5px!important;}" +
                ".subtitle{font-size:12px!important;line-height:1.4!important;}" +
                ".section{margin-bottom:18px!important;}" +
                ".section-title{align-items:flex-start!important;margin-bottom:9px!important;}" +
                ".section-title h2{font-size:16px!important;}" +
                ".grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important;width:100%!important;}" +
                ".card,.feature,.panel,.metric{min-width:0!important;border-radius:13px!important;overflow:hidden!important;}" +
                ...
                ".card h3{font-size:14px!important;line-height:1.25!important;margin:0 0 5px!important;word-break:break-word!important;}" +
                ".media-meta{font-size:10.5px!important;line-height:1.3!important;gap:4px!important;}" +
                ...
                ".card-actions{display:grid!important;grid-template-columns:1fr!important;gap:5px!important;margin-top:7px!important;}" +
                ".card-actions button{width:100%!important;min-width:0!important;min-height:38px!important;padding:8px 5px!important;font-size:10.5px!important;}" +
                ".feature{display:grid!important;grid-template-columns:92px minmax(0,1fr)!important;gap:10px!important;padding:10px!important;width:100%!important;}" +
                ".feature .poster,.feature .tmdb-poster{width:92px!important;height:138px!important;aspect-ratio:auto!important;border-radius:10px!important;}" +
                ".feature h2{font-size:18px!important;line-height:1.2!important;margin:5px 0!important;}" +
                ".actions{gap:6px!important;margin-top:8px!important;}" +
                ".actions button,.btn-primary,.btn-secondary{min-height:42px!important;padding:9px 10px!important;font-size:12px!important;}" +
                ".metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;}" +
                ".metric{padding:11px!important;}.metric strong{font-size:20px!important;}" +
                ".search{display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;gap:7px!important;}.search input{min-width:0!important;height:44px!important;}" +
