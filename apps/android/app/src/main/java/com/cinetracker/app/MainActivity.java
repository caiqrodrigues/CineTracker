...
public class MainActivity extends Activity {
    ...
    private void navigateView(String directView, String... terms) {
        ...
        words.append(']');
        String direct = directView == null ? "" : "try{view='" + directView + "';render();window.scrollTo(0,0);return true;}catch(e){}";
    ...
    private String androidPhoneLayoutScript() {
        return "(function(){" +
                ...
                "if(!document.getElementById('ct-android-phone-style')){var s=document.createElement('style');s.id='ct-android-phone-style';" +
                "s.textContent='html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important;background:#090909!important}body{margin:0!important}.app{display:block!important;width:100%!important}.sidebar,.mobile-nav,.cloud-bar{display:none!important}.content{box-sizing:border-box!important;width:100%!important;max-width:none!important;margin:0!important;padding:12px 12px 20px!important;overflow-x:hidden!important}.header{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:10px!important}.grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important}.card,.feature,.panel,.metric{min-width:0!important;border-radius:13px!important;overflow:hidden!important}.poster,.tmdb-poster{width:100%!important;height:auto!important;min-height:0!important;aspect-ratio:2/3!important;background-size:cover!important;background-position:center 18%!important}.card-body{padding:9px!important;min-height:0!important}.card h3{font-size:14px!important;line-height:1.25!important}.feature{display:grid!important;grid-template-columns:92px minmax(0,1fr)!important;gap:10px!important;padding:10px!important}.feature .poster,.feature .tmdb-poster{width:92px!important;height:138px!important;aspect-ratio:auto!important}.metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}.card-actions{display:grid!important;grid-template-columns:1fr!important;gap:5px!important}.card-actions button{width:100%!important;min-height:38px!important}.toast{left:12px!important;right:12px!important;bottom:12px!important;max-width:none!important}';document.head.appendChild(s);}" +
