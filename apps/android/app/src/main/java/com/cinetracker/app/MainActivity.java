...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "0.0.77";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.postDelayed(() -> webView.setVisibility(View.VISIBLE), 3000);
        if (savedInstanceState == null) {
            String separator = BuildConfig.WEB_URL.contains("?") ? "&" : "?";
            webView.loadUrl(BuildConfig.WEB_URL + separator + "android=1&ui=phone&apk=77");
        } else {
    ...
    private void applyStableModules() {
        String[] assets = {"ct41.js", "ct47.js", "ct48.js", "ct49.js", "ct50.js", "ct51.js", "ct58.js", "ct59.js", "ct60.js", "ct61.js", "ct62.js"};
