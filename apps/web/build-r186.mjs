...
let [html,js,css,sw,patch186,patch190]=await Promise.all([
...
console.log('WEB_R190_READY navigation=stale-first foryou=seen-swap fresh=watchlist-exclusion sports=isolated-search profile=prewarm detail=state-colors');
