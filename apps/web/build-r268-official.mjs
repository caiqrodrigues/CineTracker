...
for(const x of[
 ...
 'CT268_HOME_FIX_START','CT268_HOME_FIX_END','ct268PinHistoryFirst','__ctHistoryAuthoritative=false','__ctFastHomeCache=true','__ctHistoryAuthoritative=true',
...
must(release,'"version": "1.0.59"');must(release,'"revision": "r268-official-1.0.59"');must(release,'"home_history_authority": true');must(release,'"home_history_first": true');must(release,'"home_watch_inline_right": true');must(release,'"android": "1.0.20/10062"');
must(sw,"const CACHE='ct-web-1.0.59-r268';");must(sw,'app-v268.js');must(sw,'app-v268.css');
console.log('WEB_1_0_59_OFFICIAL_OK r268 canonical-history history-first inline-right-watch');
