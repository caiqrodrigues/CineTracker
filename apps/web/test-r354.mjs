...
ok(js.includes("window.addEventListener('click',e=>{try{const t=e.target;const direct354=window.__ctR354DirectClick;"),'true earliest r306 capture not patched');
ok(js.includes("const direct354=window.__ctR354DirectClick;"),'later first-capture bridge not patched');
