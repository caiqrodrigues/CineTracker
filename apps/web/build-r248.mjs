...
/* Current-following frontier: old holes before the last actually watched position stay
   unwatched but do not force a show out of Em dia. Never use current/next episode fields
   as the frontier, because that would hide a genuinely new release. */
