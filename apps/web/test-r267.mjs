...
for(const x of['.ct267-detail-section','.ct267-detail-x','overflow-x:auto!important','max-width:calc(100vw - 192px)!important','.ct266-watch-action{border:0!important;background:transparent!important','min-width:0!important;max-width:min(760px,88vw)!important;overflow:hidden!important','.ct169-chart-scroll.ct267-detail-x{display:block!important;width:100%!important;min-width:0!important;max-width:100%!important}','.ct169-chart-scroll.ct267-detail-x>svg{min-width:690px!important;max-width:none!important;flex:none!important'])need(css,x);
...
console.log('R267_STATIC_OK personal envelopes + atomic Discover + rich r169 rails + graph containment + glyph watch + Sports safe');
