...
const gate=spawnSync(process.execPath,['test-r314.mjs'],{
  cwd:process.cwd(),stdio:'inherit',env:{...process.env,CT_R314_SKIP_BUILD:'1'}
});
...
console.log('WEB_R314_OFFICIAL_OK profile/discover/F1 gate green');
