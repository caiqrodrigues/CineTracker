...
ok(js.includes("window.__ctR356SportsBridge=window.__ctR312SportsBridge;"),'Sports bridge alias missing');
ok(js.includes("load(force=false){return loadSports255(!!force)}"),'Sports bridge load missing');
ok(js.includes("rows(p=sport255.payload||{},tab=sport255.tab){return sportRows255(p,tab)}"),'Sports bridge rows missing');
