...
for(const must of ["window.__ctR225V119='watchlist-authoritative-sort-details-sports-controls'",'full-rpc-counts-sort-detail-open','three-column-single-actionbar-no-duplicates','minimal-consistent-controls','cinetracker_watchlist_full_v376','data-ct119-watch-media'])if(!patch.includes(must))throw new Error('Web 1.0.19 patch missing '+must);
