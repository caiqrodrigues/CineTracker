...
.ct251-sports-series-icon{display:grid!important;place-items:center!important;background-image:none!important;font-size:1.75rem!important}
...
await Promise.all([
 ...
 writeFile(resolve(dist,'release.json'),JSON.stringify({version:'1.0.42',revision:'r251-official-1.0.42',base:'r250-official-1.0.41',scope:'web-user-video-ground-truth',home:'direct-renderer+fast-canonical-prime+frontier-current-release+ratings+f1-super-bowl-series-bridge',discover:'direct-renderer+nine-functional-tabs+three-for-you-blocks+tmdb-7.5+post1990+no-pure-drama-doc+no-wwe+seven-day-history-all-blocks+no-duplicates',sports:'direct-renderer+four-tabs+72h+canonical-watched-rpc',f1:'single-owned-six-section-hub+persistent-collapse',profile:'one-collapsible-statistics-block+sport-metric',global_horizontal_scroll:'disabled',local_horizontal_scroll:'isolated',visual_polish:'home-profile-settings-sidebar',legacy_r250_reconcile:'disabled',android:'unchanged-1.0.20',generated_at:new Date().toISOString()},null,2),'utf8')
]);
