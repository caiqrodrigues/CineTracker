...
for(const x of["p_event_id:id","const CACHE='ct-web-1.0.54-r263'",'ct263-home-list','ct263-discover-card','aspect-ratio:2/3','legacy sports watch rpc signature'])must(build,x);
