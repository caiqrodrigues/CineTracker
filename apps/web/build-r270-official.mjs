...
for(const x of[
 ...
 "ct270SetImportant(action,'position','absolute')",
...
if(/ct27[0]AfterF1Paint/.test(js))throw new Error('r270 contains forbidden Sports callback');
...
if(meta.home_history_source!=='cinetracker_profile_home_payload_v0997_r5'||meta.home_history_restored!==true||meta.home_series_watch_direct_child!==true||meta.home_series_watch_inline_right!==true)throw new Error('r270 release Home flags');
