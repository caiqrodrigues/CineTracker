...
ok(js.includes("rpc('cinetracker_discover_filter_v327'"),'v327 personal exclusion authority missing');
...
ok(r.discover_filter_authority==='cinetracker_discover_filter_v327','filter authority release');
