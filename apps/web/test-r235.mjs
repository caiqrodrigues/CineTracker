...
if(js.includes("window.__ctR234V126='real-regressions-baseline-preserving-authority'"))throw new Error('r234 failed runtime was accidentally bundled');
...
console.log('TEST_R235_OK live-observer home discover sports watchlist');