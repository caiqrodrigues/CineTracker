...
const f1Marker='/* Standalone public F1 hub';if(!patch.includes(f1Marker))throw new Error('Web F1 marker missing');
...
if(!patch.includes(oldDecorate))throw new Error('Web 1.0.7 decorateAll legacy composition missing');patch=patch.replace(oldDecorate,newDecorate);
