...
let [html,js,css,sw,patch,rewatch]=await Promise.all([
 readFile(resolve(dist,'index.html'),'utf8'),readFile(resolve(dist,'app-v208.js'),'utf8'),readFile(resolve(dist,'app-v205.css'),'utf8').catch(()=>readFile(resolve(dist,'app-v208.css'),'utf8')),readFile(resolve(dist,'service-worker.js'),'utf8'),readFile(resolve(root,'runtime-r211-v107-behavior.js'),'utf8'),readFile(resolve(root,'runtime-r212-v107-rewatch-authority.js'),'utf8')
]);
...
console.log('WEB_1_0_7_READY revision=r211-official-1.0.7 rewatch=r212-direct-iife-deps');