...
for(const m of ["window.__ctR212='v107-direct-rewatch-authority'",'ct212Bound','cinetracker_mark_watch_v0994'])if(!rewatch.includes(m))throw new Error('Web 1.0.7 replay authority missing '+m);
