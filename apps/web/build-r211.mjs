...
for(const m of ["window.__ctR212='v107-direct-rewatch-authority'",'ct212Bound','cinetracker_mark_watch_v0994','stopImmediatePropagation','__ctV107EnsureMedia','__ctV107Rpc'])if(!rewatch.includes(m))throw new Error('Web 1.0.7 replay authority missing '+m);
...
// Bridge executes inside the canonical app script, so r212 receives exact app helpers regardless of browser global binding rules.
js=js.replace('\nboot();','\n'+bridge+'\n'+rewatch+'\n'+patch+'\nboot();');
