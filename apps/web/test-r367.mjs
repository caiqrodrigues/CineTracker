...
for(const x of ["window.__ctR367Marker='foryou-single-final-owner+state-derived-buttons+clicked-slot-only'","data.ct336SwapOnly=name","window.__ctR336EarlyHandle=early","grid-template-columns"])if(!js.includes(x))throw new Error('r367 missing '+x);
