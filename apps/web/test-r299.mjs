...
const [runtime,build,official]=await Promise.all(['runtime-r299-profile-sports-history.js','build-r299.mjs','build-r299-official.mjs'].map(f=>readFile(f,'utf8')));
...
console.log('R299_STATIC_OK historical r299 artifacts + clickable profile sports history + stadium presence only');
