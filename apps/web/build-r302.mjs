...
js=js.replace("window.__ctWebBuild='1.0.92';window.__ctOfficialVersion='1.0.92';","window.__ctWebBuild='1.0.93';window.__ctOfficialVersion='1.0.93';")
 ...
 .replace('\nboot();','\n'+runtime+'\nboot();');
css+=String.raw`
/* CineTracker Web 1.0.93 r302 — finite lifecycle, restored Sports filters and complete F1 detail. */
...
const prev=JSON.parse(releaseRaw),release={...prev,version:'1.0.93',revision:'r302-official-1.0.93',base:'r301-production',scope:'discover-personal-filter-foryou-sports-filters-f1-detail-stability-web-only',discover_seen_excluded:true,discover_watchlist_excluded:true,discover_add_watchlist:true,discover_for_you_fixed:true,sports_profile_global_observer:false,sports_filters_restored:true,sports_next_days:365,f1_drivers_tab:false,f1_calendar_interactive:true,f1_calendar_detail_complete:true,android:'1.0.20/10062'};
...
console.log('WEB_R302_READY Discover personal filtering + canonical Watchlist + fixed Pra Você + Sports filters/365d + complete F1 detail + stable Sports/Profile; Android preserved');
