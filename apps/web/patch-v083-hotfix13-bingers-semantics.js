...
function preview13(data,name){
  ...
  o.innerHTML=`<div class="ct10-preview-card"><h2>Prévia da importação</h2><p class="ct10-muted">Nenhum dado foi alterado. Confira os números antes de confirmar.</p>${mismatch}<div class="ct10-safe">Somente <b>library.csv</b> e <b>watches.csv</b> são importados. ratings.csv, avaliações, comentários e lists.csv são ignorados.</div><div class="ct10-preview-grid">
