...
sw=sw.replace(/const VERSION='[^']+';/,"const VERSION='ct-web-1.0.2-r206';").replaceAll('app-v205.js','app-v206.js').replaceAll('r205-official-1.0.1','r206-official-1.0.2');
sw += '\n// Web application bundle identity: app-v206.js\n';
