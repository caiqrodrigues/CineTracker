...
const fy=js.match(/function paintForYou263\(\)\{[\s\S]*?\}\nasync function loadBrowse263/)?.[0]||'';if(!fy)throw new Error('R266 active Pra Você producer missing');if(fy.includes('Da sua Watchlist')||fy.includes('d.watch'))throw new Error('R266 active Pra Você still recommends Watchlist');must(fy,"block263('Indicação do Dia'");must(fy,"block263('100% Novos'");
