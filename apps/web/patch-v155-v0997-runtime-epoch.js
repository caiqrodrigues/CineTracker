(() => {
'use strict';
if(window.__ct0997RuntimeEpoch155Loaded)return;
window.__ct0997RuntimeEpoch155Loaded=true;
window.__ct0997RuntimeEpoch155='r155-runtime-epoch';
window.__ctRuntimeEpoch='r155';
...
function clearOldIndexedDb(){
  try{for(const name of['cinetracker-preload-v1','cinetracker-preload-r153','cinetracker-preload-r154'])indexedDB.deleteDatabase(name)}catch{}
}
...
window.__ct155InvalidateVersionedCaches=()=>{clearVersionedSession();clearOldIndexedDb();clearOldCacheStorage();return true};
})();
