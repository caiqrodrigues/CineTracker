...
for(const x of['[data-home] .home-tabs{position:sticky!important;top:0!important','visibility:visible!important;opacity:1!important','z-index:20!important'])must(css,x);
const meta=JSON.parse(release);if(meta.version!=='1.0.69'||meta.revision!=='r278-official-1.0.69'||meta.home_watch_action_tmdb_source!=='effective'||meta.home_watch_action_data_media_fallback!==true||meta.home_tabs_sticky!==true||meta.android!=='1.0.20/10062')throw new Error('R278_STATIC release flags');
console.log('R278_STATIC_OK effective-tmdb watched-actions sticky-home-tabs');
