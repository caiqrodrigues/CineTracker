...
(async()=>{const A=(c,m)=>{if(!c)throw new Error(m)};try{
 ...
 document.body.dataset.test='PASS';document.body.insertAdjacentHTML('beforeend','<pre>R260_BROWSER_PASS width=${width} cache='+Math.round(cachedMs)+'ms</pre>');
}catch(e){document.body.dataset.test='FAIL';document.body.insertAdjacentHTML('beforeend','<pre>R260_BROWSER_FAIL '+String(e&&e.stack||e)+'</pre>')}})();
</script></body>`}
