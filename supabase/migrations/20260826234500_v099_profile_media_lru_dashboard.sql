drop function if exists public.cinetracker_profile_media_dashboard();

create function public.cinetracker_profile_media_dashboard()
returns table (
  media_id bigint,
  media_type text,
  media_kind text,
...
grant execute on function public.cinetracker_profile_media_dashboard() to authenticated;
