CREATE OR REPLACE FUNCTION public.cinetracker_discover_filter_v326(p_items jsonb)
 RETURNS jsonb
 LANGUAGE sql
 STABLE
...
$function$
;
revoke execute on function public.cinetracker_discover_filter_v326(jsonb) from public,anon;
grant execute on function public.cinetracker_discover_filter_v326(jsonb) to authenticated;
